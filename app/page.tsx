  ...
  return (
    <>
      <div className="block xl:grid xl:grid-cols-2 -w-[1600px] mx-auto min-h-screen">
        {/* Sidebar */}
        <aside className="xl:sticky xl:top-0 xl:h-screen text-white p-8 sm:p-16 sm:pb-0  xl:pt-24 pb-0 max-w-4xl mx-auto xl:max-w-[auto] flex flex-col gap-12">
          <Profile />
        ...
        {/* Main Content */}
        <main className=" overflow-y-auto p-8 sm:p-16 sm:pt-4 pt-4 xl:pt-24 max-w-4xl mx-auto xl:max-w-[auto]">
